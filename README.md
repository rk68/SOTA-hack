...
This repository showcases a notebook demonstrating **dynamic text augmentation** and **iterative text rewriting** driven by *neuron-level activations* in a language model. (Note this readme file was generated by AI so may not be perfectly accurate)
